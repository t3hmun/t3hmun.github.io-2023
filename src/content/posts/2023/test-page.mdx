...
```
Now i need to type many hundreds of characters to see how the code block handles it when clicking on the expand button, which I created to allow you to view code using the full width of your monitor.
```
